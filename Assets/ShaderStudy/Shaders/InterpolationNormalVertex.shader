Shader "Unlit/InterpolationNormalVertex"
{
		...
		SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag(VertexOutput o) : SV_Target
			{
				...
				return float4(specularFalloff.xxx, 0);		// En este resultado las normales de los fragmentos de los poligonos se quedan muy cortas al hacer la interpolación entre las normales de los vertices.
